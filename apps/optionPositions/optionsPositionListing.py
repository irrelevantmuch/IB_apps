...
from PyQt6.QtCore import QSize, pyqtSlot, pyqtSignal, Qt

from PyQt6 import QtCore, QtGui, QtWidgets
from PyQt6.QtGui import QPalette, QColor
from PyQt6.QtWidgets import QTabBar, QStylePainter, QStyleOptionTab
import numpy as np
...
class OptionPositions(OptionPositionWindow):
    ...
    def __init__(self, position_manager):
        ...
        self.data_object.position_signal.connect(self.positionUpdate, Qt.ConnectionType.QueuedConnection)
        self.price_signal_request.connect(self.position_manager.requestMarketData, Qt.ConnectionType.QueuedConnection)
