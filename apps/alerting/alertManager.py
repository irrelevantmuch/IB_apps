...
class AlertManager(AlertWindow):
    ...
    def toggleMessageListening(self, value):
        if (not self.message_listening) and value:
            self.listenForMessageUpdates()
    ...
    def listenForMessageUpdates(self):
        pass
        # delay_seconds = self.message_seconds_spinbox.value() * 1000
        # self.message_check_timer = QTimer()
        # self.message_check_timer.timeout.connect(self.checkMessages)
        # self.message_check_timer.start(delay_seconds)
