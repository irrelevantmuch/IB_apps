...
class OptionVisualization(VisualizationWindow):
    ...
    def connectManagerAndPlots(self, option_data_manager):
        option_data_manager.api_updater.connect(self.apiUpdate, Qt.ConnectionType.QueuedConnection)
        option_data_manager.latest_price_signal.connect(self.underlyingPriceUpdate, Qt.ConnectionType.QueuedConnection)
        ...
        self.min_all_strike.connect(self.all_option_frame.setMinimumStrike, Qt.ConnectionType.QueuedConnection)
        self.max_all_strike.connect(self.all_option_frame.setMaximumStrike, Qt.ConnectionType.QueuedConnection)
        self.min_all_expiration.connect(self.all_option_frame.setMinimumExpiration, Qt.ConnectionType.QueuedConnection)
        self.max_all_expiration.connect(self.all_option_frame.setMaximumExpiration, Qt.ConnectionType.QueuedConnection)
    ...
    def connectSignals(self):
        self.stock_selection_signal.connect(self.option_data_manager.makeStockSelection, type=Qt.ConnectionType.QueuedConnection)
        self.req_all_strikes.connect(self.option_data_manager.requestForAllStrikesAndExpirations, type=Qt.ConnectionType.QueuedConnection)
        self.req_by_strike_execute.connect(self.option_data_manager.requestOptionPricesForStrike, type=Qt.ConnectionType.QueuedConnection)

        self.req_by_exp.connect(self.option_data_manager.requestOptionPricesForExpiration, type=Qt.ConnectionType.QueuedConnection)
        self.req_by_exp_execute.connect(self.option_data_manager.requestOptionPricesForExpiration, type=Qt.ConnectionType.QueuedConnection)

        self.flush_button.clicked.connect(self.option_data_manager.flushData, type=Qt.ConnectionType.QueuedConnection)
        self.reset_button.clicked.connect(self.option_data_manager.resetWholeChain, type=Qt.ConnectionType.QueuedConnection)

        self.constr_change_signal.connect(self.option_data_manager.structureSelectionChanged, type=Qt.ConnectionType.QueuedConnection)
