...
class PositionManager(PositionManagerWindow):
    ...
    def __init__(self, position_manager):
        ...
        self.manage_tab.list_updater.connect(self.apiUpdate)

        self.data_management = position_manager
        self.data_management.api_updater.connect(self.apiUpdate)
    ...
    def apiUpdate(self, signal, sub_signal):
        print(f"StockPostions.apiUpdate: {signal}")
