...
class ComparisonWindow(ProcessorWindow, Comparison_UI):
    ...
    def prepTables(self):
        self.auto_corr_table.horizontalHeader().setSectionResizeMode(QHeaderView.ResizeMode.ResizeToContents)
...
#        self.period_selector.setEnabled(value==0)
    ...
    def setTableProperties(self):
        ...
        #     self.low_table.horizontalHeader().setSectionResizeMode(column_index, QHeaderView.ResizeMode.Stretch)
        #     self.high_table.horizontalHeader().setSectionResizeMode(column_index, QHeaderView.ResizeMode.Stretch)

        # # for column_index in self.step_mapping.keys():
        #     self.step_up_table.horizontalHeader().setSectionResizeMode(column_index, QHeaderView.ResizeMode.ResizeToContents)
        #     self.step_down_table.horizontalHeader().setSectionResizeMode(column_index, QHeaderView.ResizeMode.ResizeToContents)
