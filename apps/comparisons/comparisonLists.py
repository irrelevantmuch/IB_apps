...
class ComparisonList(ComparisonWindow):
    ...
    def connectSlotsToSignals(self):
        self.fetch_range_signal.connect(self.data_processor.fetchStockRangeData, Qt.ConnectionType.QueuedConnection)
        ...
        self.check_list_signal.connect(self.data_processor.setCheckLists, Qt.ConnectionType.QueuedConnection)
        self.update_property_signal.connect(self.data_processor.updateProperties, Qt.ConnectionType.QueuedConnection)
