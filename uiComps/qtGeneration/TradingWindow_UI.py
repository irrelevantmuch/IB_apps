...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vertical_stack.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetDefaultConstraint)
        ...
        self.account_selector = QtWidgets.QComboBox(parent=self.centralwidget)
        ...
        self.symbol_radio = QtWidgets.QRadioButton(parent=self.centralwidget)
        ...
        self.search_field = QuickLineEdit(parent=self.centralwidget)
        ...
        self.list_layout.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetDefaultConstraint)
        self.list_layout.setObjectName("list_layout")
        self.list_radio = QtWidgets.QRadioButton(parent=self.centralwidget)
        ...
        self.ticker_selection = QtWidgets.QComboBox(parent=self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.buy_radio = QtWidgets.QRadioButton(parent=self.tab_2)
        ...
        self.sell_radio = QtWidgets.QRadioButton(parent=self.tab_2)
        ...
        self.bid_price_button = QtWidgets.QPushButton(parent=self.tab_2)
        ...
        self.last_price_button = QtWidgets.QPushButton(parent=self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.ask_price_button = QtWidgets.QPushButton(parent=self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.count_field = QtWidgets.QSpinBox(parent=self.tab_2)
        ...
        self.market_order_box = QtWidgets.QCheckBox(parent=self.tab_2)
        self.market_order_box.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.limit_field = QtWidgets.QDoubleSpinBox(parent=self.tab_2)
        ...
        self.submit_button = QtWidgets.QPushButton(parent=self.tab_2)
        ...
        self.stop_loss_check = QtWidgets.QCheckBox(parent=self.tab_2)
        ...
        self.stop_trigger_field = QtWidgets.QDoubleSpinBox(parent=self.tab_2)
        ...
        self.stop_limit_check = QtWidgets.QCheckBox(parent=self.tab_2)
        ...
        self.stop_limit_field = QtWidgets.QDoubleSpinBox(parent=self.tab_2)
        ...
        self.profit_take_check = QtWidgets.QCheckBox(parent=self.tab_2)
        ...
        self.profit_limit_field = QtWidgets.QDoubleSpinBox(parent=self.tab_2)
        ...
        self.combo_buy_radio = QtWidgets.QRadioButton(parent=self.tab_3)
        ...
        self.combo_sell_radio = QtWidgets.QRadioButton(parent=self.tab_3)
        ...
        self.combo_limit_field = QtWidgets.QDoubleSpinBox(parent=self.tab_3)
        ...
        self.combo_sl_trigger_field = QtWidgets.QDoubleSpinBox(parent=self.tab_3)
        ...
        self.combo_sl_check = QtWidgets.QCheckBox(parent=self.tab_3)
        ...
        self.combo_stop_limit_field = QtWidgets.QDoubleSpinBox(parent=self.tab_3)
        ...
        self.oco_button = QtWidgets.QPushButton(parent=self.tab_3)
        ...
        self.step_buy_radio = QtWidgets.QRadioButton(parent=self.stair_step_tab)
        ...
        self.step_sell_radio = QtWidgets.QRadioButton(parent=self.stair_step_tab)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.stair_step_tab)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_2.addWidget(self.label_5)
        self.step_bar_label = QtWidgets.QLabel(parent=self.stair_step_tab)
        ...
        self.step_stop_trigger_offset_box = QtWidgets.QDoubleSpinBox(parent=self.stair_step_tab)
        ...
        self.step_entry_limit_offset_box = QtWidgets.QDoubleSpinBox(parent=self.stair_step_tab)
        ...
        self.step_entry_trigger_offset_box = QtWidgets.QDoubleSpinBox(parent=self.stair_step_tab)
        ...
        self.step_stop_trigger_label = QtWidgets.QLabel(parent=self.stair_step_tab)
        ...
        self.label_18 = QtWidgets.QLabel(parent=self.stair_step_tab)
        self.label_18.setObjectName("label_18")
        self.gridLayout_5.addWidget(self.label_18, 0, 4, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=self.stair_step_tab)
        font = QtGui.QFont()
        font.setBold(True)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.gridLayout_5.addWidget(self.label_6, 1, 1, 1, 1)
        self.step_stop_limit_offset_box = QtWidgets.QDoubleSpinBox(parent=self.stair_step_tab)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.stair_step_tab)
        self.label_7.setObjectName("label_7")
        self.gridLayout_5.addWidget(self.label_7, 0, 2, 1, 1)
        self.step_stop_limit_label = QtWidgets.QLabel(parent=self.stair_step_tab)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.stair_step_tab)
        font = QtGui.QFont()
        font.setBold(True)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.gridLayout_5.addWidget(self.label_3, 0, 1, 1, 1)
        self.step_stoploss_check = QtWidgets.QCheckBox(parent=self.stair_step_tab)
        ...
        self.step_profit_check = QtWidgets.QCheckBox(parent=self.stair_step_tab)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.step_profit_factor_radio = QtWidgets.QRadioButton(parent=self.stair_step_tab)
        ...
        self.step_profit_factor_spin = QtWidgets.QSpinBox(parent=self.stair_step_tab)
        ...
        self.step_profit_offset_radio = QtWidgets.QRadioButton(parent=self.stair_step_tab)
        ...
        self.step_profit_offset_spin = QtWidgets.QDoubleSpinBox(parent=self.stair_step_tab)
        ...
        self.step_profit_price_radio = QtWidgets.QRadioButton(parent=self.stair_step_tab)
        ...
        self.step_profit_price_spin = QtWidgets.QDoubleSpinBox(parent=self.stair_step_tab)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.stair_step_tab)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        self.step_count_field = QtWidgets.QSpinBox(parent=self.stair_step_tab)
        ...
        self.step_button = QtWidgets.QPushButton(parent=self.stair_step_tab)
        font = QtGui.QFont()
        ...
        self.line = QtWidgets.QFrame(parent=self.stair_step_tab)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.gridLayout.addWidget(self.line, 3, 0, 1, 1)
        self.line_2 = QtWidgets.QFrame(parent=self.stair_step_tab)
        ...
        self.order_table = QtWidgets.QTableView(parent=self.tab)
        self.order_table.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.DoubleClicked|QtWidgets.QAbstractItemView.EditTrigger.EditKeyPressed|QtWidgets.QAbstractItemView.EditTrigger.SelectedClicked)
        ...
        self.cancel_all_button = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.step_order_table = QtWidgets.QTableView(parent=self.tab_4)
        ...
        self.price_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.bar_selector = QtWidgets.QComboBox(parent=self.centralwidget)
