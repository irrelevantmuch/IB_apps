...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.option_value_label = QtWidgets.QLabel(parent=self.tab)
        self.option_value_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.option_value_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.short_value_label = QtWidgets.QLabel(parent=self.tab)
        self.short_value_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.short_value_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.short_value_label.setObjectName("short_value_label")
        self.gridLayout_2.addWidget(self.short_value_label, 1, 8, 1, 1)
        self.short_dpnl_label = QtWidgets.QLabel(parent=self.tab)
        self.short_dpnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.short_dpnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.long_dpnl_label = QtWidgets.QLabel(parent=self.tab)
        self.long_dpnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.long_dpnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.long_dpnl_label.setObjectName("long_dpnl_label")
        self.gridLayout_2.addWidget(self.long_dpnl_label, 3, 3, 1, 1)
        self.overall_upnl_label = QtWidgets.QLabel(parent=self.tab)
        self.overall_upnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.overall_upnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.short_upnl_label = QtWidgets.QLabel(parent=self.tab)
        self.short_upnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.short_upnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.overall_dpnl_label = QtWidgets.QLabel(parent=self.tab)
        self.overall_dpnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.overall_dpnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.hodl_dpnl_label = QtWidgets.QLabel(parent=self.tab)
        self.hodl_dpnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.hodl_dpnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.hodl_upnl_label = QtWidgets.QLabel(parent=self.tab)
        self.hodl_upnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.hodl_upnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.hodl_upnl_label.setObjectName("hodl_upnl_label")
        self.gridLayout_2.addWidget(self.hodl_upnl_label, 7, 8, 1, 1)
        self.hodl_value_label = QtWidgets.QLabel(parent=self.tab)
        self.hodl_value_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.hodl_value_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.hodl_value_label.setObjectName("hodl_value_label")
        self.gridLayout_2.addWidget(self.hodl_value_label, 5, 8, 1, 1)
        self.long_upnl_label = QtWidgets.QLabel(parent=self.tab)
        self.long_upnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.long_upnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.long_value_label = QtWidgets.QLabel(parent=self.tab)
        self.long_value_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.long_value_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.long_value_label.setObjectName("long_value_label")
        self.gridLayout_2.addWidget(self.long_value_label, 1, 3, 1, 1)
        self.option_upnl_label = QtWidgets.QLabel(parent=self.tab)
        self.option_upnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.option_upnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.ratio_label = QtWidgets.QLabel(parent=self.tab)
        self.ratio_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.account_value_label = QtWidgets.QLabel(parent=self.tab)
        self.account_value_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.account_value_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.account_value_label.setObjectName("account_value_label")
        self.gridLayout_2.addWidget(self.account_value_label, 12, 8, 1, 1)
        self.option_dpnl_label = QtWidgets.QLabel(parent=self.tab)
        self.option_dpnl_label.setMaximumSize(QtCore.QSize(200, 16777215))
        self.option_dpnl_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
